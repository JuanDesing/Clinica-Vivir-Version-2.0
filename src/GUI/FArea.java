...
public class FArea extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        id.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(11, 17, 113)));
        ...
        nombre.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(11, 17, 113)));
        ...
        buscar2.setForeground(new java.awt.Color(0, 51, 113));
        ...
        limpiar1.setForeground(new java.awt.Color(0, 51, 113));
    ...
    private void listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarActionPerformed
        ...
        try {
            ...
            while (rs.next()) {
                ...
                areaa += rs.getString("id_area") + "\t" + rs.getString("nombre_area") + "\t" + rs.getString("descripcion_area") + "\n";

            }

            Archivo.grabar("Areas.xls", areaa);
...
//        JOptionPane.showMessageDialog(null, "Archivo Generado");
    ...
    private void idMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_idMouseMoved
        id.setBackground(new java.awt.Color(127, 170, 229));
        id.setForeground(new java.awt.Color(11, 17, 113));
...
//                JOptionPane.showMessageDialog(null, "El Area no existe");
    ...
    private void descMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_descMouseMoved
        ...
        desc.setBackground(new java.awt.Color(127, 170, 229));
        desc.setForeground(new java.awt.Color(11, 17, 113));
