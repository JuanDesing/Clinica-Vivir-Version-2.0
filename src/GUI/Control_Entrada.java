...
public class Control_Entrada extends javax.swing.JFrame {
    ...
    public Control_Entrada() {
        try {
            ...
            doctorasignado.addItem("Seleccione");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        registrarentrada.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void registrarentradaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarentradaActionPerformed
        ...
        if (estpaciente.getSelectedIndex() == 0) {
            WarningAlertCerrar wa = new WarningAlertCerrar(this, true);
            wa.titulo.setText("SELECCIONE EL ESTADO DEL PACIENTE!");
            wa.titulo.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
            wa.titulo.setForeground(new java.awt.Color(153, 153, 153));
            wa.setVisible(true);
        } else if (doctorasignado.getSelectedIndex() == 0) {
            WarningAlertCerrar wa = new WarningAlertCerrar(this, true);
            wa.titulo.setText("SELECCIONE EL DOCTOR!");
            wa.titulo.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
            wa.titulo.setForeground(new java.awt.Color(153, 153, 153));
            wa.setVisible(true);
        } else {
            try {
                ...
                ResultSet rs2 = con.consultar("select * from control_entrada_salida where fecha_salida > '" + Fechaingreso.getDate() + "' and paciente_cedula_paciente = '" + ced2.getText() + "' ");

                if (rs2.next()) {

                    ErrorAlert1 eag = new ErrorAlert1(this, true);
                    eag.t1.setText("¡Verifique la fecha de entrada, este paciente");
                    eag.t1.setFont(new java.awt.Font("Century Gothic", 1, 17)); // NOI18N
                    eag.t2.setText("ya estuvo en la clínica segun esta fecha!");
                    eag.t2.setFont(new java.awt.Font("Century Gothic", 1, 17)); // NOI18N
...
//fueradelshile
                    ...
                    sa.titulo.setText("¡Entrada registrada exitosamente!");
