...
public class FPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buscar1.setForeground(new java.awt.Color(0, 51, 113));
    ...
    private void listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listarActionPerformed
        ...
        for (int i = 0; i < LogIn.listapacientes.size(); i++) {
            ...
            cad += pac.getCedula() + "\t" + pac.getPrimernombre() + "\t" + pac.getPrimerapellido() + pac.getCorreo()
                    + pac.getEdad() + pac.getTelefono() + "\n";
        }
...
//                agregar.setEnabled(true);
    ...
    private void edadMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_edadMouseMoved
        ...
        edad.setBackground(new java.awt.Color(127, 170, 229));
        edad.setForeground(new java.awt.Color(11, 17, 113));
