...
//        }
    ...
    private void initComponents() {
        ...
        jPanel7.setBackground(new java.awt.Color(224, 241, 247));
        jPanel7.setPreferredSize(new java.awt.Dimension(282, 476));
        jPanel7.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel5.setBackground(new java.awt.Color(0, 51, 113));
        ...
        buuscarxnombre.setForeground(new java.awt.Color(0, 51, 113));
        ...
        jPanel7.add(buuscarxnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 190, 27));
        ...
        buuscarxtipmedico.setForeground(new java.awt.Color(0, 51, 113));
...
//        obj.registrarentrada.setEnabled(true);
    ...
    private void buuscarxtipmedicoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buuscarxtipmedicoKeyReleased
        ...
        try {
            ...
            ResultSet rs = con.consultar("select * from control_entrada_salida where doctor_cedula_doctor in (select cedula_doctor from doctor where tipomedico_doctor = '" + buuscarxtipmedico.getText().toUpperCase() + "')");
...
//                con.ConexionPostgres();
//
//                ResultSet rs = con.consultar("select primer_nombre_paciente from paciente where cedula_paciente = " + tabla.getValueAt(tabla.getSelectedRow(), 1).toString() + " ");
//
//                if (rs.next()) {
//                    es.nombre.setText(rs.getString(1));
//                }
//
//                ResultSet rs2 = con.consultar("select primer_nombre_doctor from doctor where cedula_doctor = " + tabla.getValueAt(tabla.getSelectedRow(), 2).toString() + " ");
//
//                if (rs2.next()) {
//                    es.doctorasignado.setSelectedItem(tabla.getValueAt(tabla.getSelectedRow(), 2).toString() + " - " + rs2.getString(1));
//                }
//
//                es.ced2.setText(tabla.getValueAt(tabla.getSelectedRow(), 1).toString());
//                //es.Fechaingreso.setDate(tabla.getValueAt(tabla.getSelectedRow(), 5).);
//                //es.fechadesalida.setDate(tabla.getValueAt(tabla.getSelectedRow(), 5).toString());
//                es.estpaciente.setSelectedItem(tabla.getValueAt(tabla.getSelectedRow(), 3).toString());
//                es.valor.setText(tabla.getValueAt(tabla.getSelectedRow(), 6).toString());
//                
//                es.setVisible(true);
//
//            } catch (ClassNotFoundException ex) {
...
//                    + "\nlista para ser impresa!");
            ...
            sa.titulo.setText("¡Factura Generada!");
            sa.titulo.setFont(new java.awt.Font("Century Gothic", 1, 20)); // NOI18N
    ...
    private void buuscarxnombreKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buuscarxnombreKeyReleased
        ...
        try {
            ...
            ResultSet rs = con.consultar("select * from control_entrada_salida where doctor_cedula_doctor = (select cedula_doctor from doctor where primer_nombre_doctor = '" + buuscarxnombre.getText().toUpperCase() + "')");
